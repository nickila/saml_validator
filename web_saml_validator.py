...
def saml_analysis(doc):
    ...
    important_values['not_before'] = doc['samlp:Response']['saml:Assertion']['saml:Conditions']['@NotBefore']
    important_values['time_sent'] = doc['samlp:Response']['@IssueInstant']
    important_values['not_on_or_after'] = doc['samlp:Response']['saml:Assertion']['saml:Conditions']['@NotOnOrAfter']

# Use if we need time objects to compare, (time skew issues)
    ...
    return str({'important_values': important_values, 'error_list': error_list})
